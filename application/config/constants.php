...
|
| DO NOT CHANGE these items if you don't know the valid value
| Irresponsible customized values may harm the whole APIs
|
| ENSURE you know the detail if you wanna change each of constant
|
*/
...
defined('FUSION_APP_NAME')				OR define('FUSION_APP_NAME', 'DiLo Festival');
